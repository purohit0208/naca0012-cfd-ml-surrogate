...
Primary public sources used by the manuscript and release package:
...
- Roache (1994) GCI formulation metadata: https://www.osti.gov/biblio/6817347
...
The public package does not include downloaded full-text literature PDFs, private drafts, or paid-software raw outputs. Numerical comparison values from prior local manuscript work are included only as processed comparison values where they are needed to reproduce the manuscript tables.
